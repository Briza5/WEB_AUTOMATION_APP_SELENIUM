...
class App:
    ...
    def close_browser(self):
        self.webautomation.close()  # Call the close method to close the browser
        messagebox.showinfo(
            "Browser Closed", "The browser has been closed successfully.")
